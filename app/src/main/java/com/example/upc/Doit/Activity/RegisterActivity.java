...
import com.example.upc.Doit.data.UserService;
        ...
        switch (v.getId()) {
            case R.id.btn_register:
                ...
                if (NetWorkUtils.isNetworkConnected(getApplication())) {
                    ...
                    com.example.upc.Doit.data.User user=new com.example.upc.Doit.data.User();
                 ...
                 /*   final User user = new User();
                    final String path = this.getApplicationContext().getFilesDir().getAbsolutePath()
                        + "/default_head.png";
                    Log.i("register", path);
