...
import com.example.upc.Doit.Adapter.FragmentAdapter;
import com.example.upc.Doit.Fragment.ClockFragment;
import com.example.upc.Doit.Fragment.TodoFragment;
...
import com.example.upc.Doit.Widget.CircleImageView;
    ...
    private void runNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.course:
                ...
                Intent intent4 = new Intent(MainActivity.this, com.example.upc.Doit.jay.surpertableui.MainActivity.class);
